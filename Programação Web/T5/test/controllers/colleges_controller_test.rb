...
class CollegesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create college' do
    assert_difference('College.count') do
      post colleges_url, params: { college: { c_type: @college.c_type, name: @college.name } }
    end
  ...
  test 'should update college' do
    patch college_url(@college), params: { college: { c_type: @college.c_type, name: @college.name } }
