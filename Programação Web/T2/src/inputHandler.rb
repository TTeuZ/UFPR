def showSchema
    puts
    puts 'CREATE TABLE IF NOT EXISTS "colleges" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar, "c_type" varchar, "created_at" datetime(6) NOT NULL, "updated_at" datetime(6) NOT NULL);'
    puts 'CREATE TABLE sqlite_sequence(name,seq);'
    puts 'CREATE TABLE IF NOT EXISTS "students" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar, "age" integer, "register" varchar, "college_id" integer, "created_at" datetime(6) NOT NULL, "updated_at" datetime(6) NOT NULL, CONSTRAINT "fk_rails_1d4ff93d0b"'
    ...
    puts 'CREATE TABLE IF NOT EXISTS "addresses" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "streat" varchar, "number" integer, "student_id" integer, "created_at" datetime(6) NOT NULL, "updated_at" datetime(6) NOT NULL, CONSTRAINT "fk_rails_c23856a13c"'
