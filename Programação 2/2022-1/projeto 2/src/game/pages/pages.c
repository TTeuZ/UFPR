...
void draw_home_page (player_points_t p_points, fonts_t fonts, game_cond_t game_cond, images_t images) {
    ...
    al_draw_textf (fonts.button_home, al_map_rgb(0, 0, 0), 27, 9, 0, "I");

    // moedas
    al_draw_textf (fonts.points_home, al_map_rgb(255, 255, 255), 375 - ((6 + decimal_cases)  * decimal_cases), 10, 0, "%d", p_points.coins);
    ...
    al_draw_textf (fonts.button_home, al_map_rgb(255, 255, 255), 180, 386, 0, "PLAY");
...
void draw_help_page (fonts_t fonts, images_t images) {
    ...
    // Titulo
    al_draw_textf (fonts.title_help, al_map_rgb(255, 255, 255), 75, 130, 0, "Como jogar");

    // Mira
    al_draw_textf (fonts.text_help, al_map_rgb(255, 255, 255), 30, 200, 0, "Pressione com o mouse para ajustar");
    al_draw_textf (fonts.text_help, al_map_rgb(255, 255, 255), 135, 220, 0, "o angulo de tiro");
