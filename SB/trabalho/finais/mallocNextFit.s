...
# ---------------------------------------------
    ...
    movq $30, %rdi                              # primeira alocação
    call alocaMem
    movq %rdi, -8(%rbp)
    call imprimeMapa

    movq $40, %rdi                              # segunda alocação
    call alocaMem
    movq %rdi, -16(%rbp)
    call imprimeMapa
    ...
    movq -24(%rbp), %rdi                        # primeira desalocação
    call liberaMem
    call imprimeMapa

    movq $35, %rdi                              # primeira alocação
    call alocaMem
    movq %rdi, -8(%rbp)
    call imprimeMapa

    movq $40, %rdi                              # primeira alocação
    call alocaMem
    movq %rdi, -16(%rbp)
    call imprimeMapa
