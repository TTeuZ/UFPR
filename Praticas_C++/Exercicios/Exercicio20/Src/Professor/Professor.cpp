...
namespace ufpr {
// Constructors
Professor::Professor(const std::string& nome, const CPF& cpf, const uint16_t valorHora, const uint8_t cargaHoraria)
...
// Setters
void Professor::setValorHora(const uint16_t valorHora) { this->valorHora = valorHora; }

void Professor::setCargaHoraria(const uint8_t cargaHoraria) { this->cargaHoraria = cargaHoraria; }
