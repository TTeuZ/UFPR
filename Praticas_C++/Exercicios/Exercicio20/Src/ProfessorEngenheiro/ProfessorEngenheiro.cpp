...
namespace ufpr {
// Constructor
ProfessorEngenheiro::ProfessorEngenheiro(const std::string& nome, const CPF& cpf, const uint16_t valorHora,
                                         const uint8_t cargaHoraria, const uint16_t numeroCrea)
