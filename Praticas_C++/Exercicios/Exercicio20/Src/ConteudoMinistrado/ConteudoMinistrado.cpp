...
// Constructors
ConteudoMinistrado::ConteudoMinistrado(const std::string& descricao, const uint8_t cargaHorariaConteudo)
...
uint8_t ConteudoMinistrado::getCargaHorariaConteudo() const { return this->cargaHorariaConteudo; }
