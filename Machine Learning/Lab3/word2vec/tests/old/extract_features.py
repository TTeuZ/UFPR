...
def write_results(result, reviews):
    ...
    file = open(
        f"../features/train_{config.VectorSize}_{config.WindowSize}_{config.MinCount}_{config.method}.txt", "w")
    ...
    file = open(
        f"../features/test_{config.VectorSize}_{config.WindowSize}_{config.MinCount}_{config.method}.txt", "w")
