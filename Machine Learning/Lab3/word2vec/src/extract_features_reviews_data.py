...
def write_results(result, reviews, size, window, count, method):
    ...
    file = open(
        f"../reviews_data/features/train_{size}_{window}_{count}_{method}.txt", "w")
    ...
    file = open(
        f"../reviews_data/features/test_{size}_{window}_{count}_{method}.txt", "w")
        ...
        for window in windows:
            for count in counts:
                ...
                for method in methods:
                    ...
                    write_results(results, reviews, size,
                                  window, count, method)
